...
//   plugin-name   delivery-team | librarian | dev-workflow | story-map | product-analyst | engineering-manager
...
const ALL_PLUGINS = ['delivery-team', 'librarian', 'dev-workflow', 'story-map', 'product-analyst', 'engineering-manager'];
