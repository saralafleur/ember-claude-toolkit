...
- **Persistent memory** (read these FIRST — locations per `PROJECT-CONTEXT.md`
  ...
  - `~/.gemini/config/plugins/delivery-team/skills/team-intake/memory/request-log.md` (or this project's
    own, if `PROJECT-CONTEXT.md` names one)
  - `~/.gemini/config/plugins/delivery-team/skills/team-intake/memory/decision-log.md` (or this project's
