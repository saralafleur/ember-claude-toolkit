...
_This agent reads and searches files and runs shell commands (git worktree/status, repo discovery, Docker compose scaffolding) and writes the build brief; it does not edit product code._
