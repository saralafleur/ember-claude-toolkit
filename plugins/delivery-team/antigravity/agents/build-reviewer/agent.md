...
_This agent reads and searches files and runs git/diff commands, writing its review findings; it is read-only with respect to code and does not fix anything._
