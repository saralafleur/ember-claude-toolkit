...
You typically need to read files, search and glob across the repo, and
write/edit the release documents (no shell or commit access — verification is
the release-lead's job).
