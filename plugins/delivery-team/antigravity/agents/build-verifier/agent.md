...
_This agent reads and searches files and runs shell/test/Docker commands, writing the green-evidence record; it runs and reads only and does not edit code._
