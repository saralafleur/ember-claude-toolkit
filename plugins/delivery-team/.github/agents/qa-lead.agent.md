...
## What to produce
Write `<output-dir>/test-plan.md` following the team-qa test-plan format (the
canonical template lives in this plugin's team-qa skill templates) — the QA
deliverable an implementer can execute without re-deriving the investigation:
