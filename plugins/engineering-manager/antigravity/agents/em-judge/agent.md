...
_This agent reads and searches files and runs shell commands to re-derive the overlap picture independently; it does not write or edit any file, dispatch anything, or make the final call._
