...
_This agent reads and searches files and runs shell commands to compare candidate items' plans; it does not write or edit any file, dispatch anything, or make the final call._
