...
- **Self-improvements:** apply approved edits to the librarian orchestrator, the
  `librarian-*` agents, templates, or taxonomy, and approved new lines in
...
- **Wire up a repo's AGENTS.md:** insert the `agents-md-block.md` content with
