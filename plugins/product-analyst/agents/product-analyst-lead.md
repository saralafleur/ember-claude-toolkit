...
> `~/.claude/skills/product-analyst/...` path below means "the same-named
...
- `~/.claude/skills/product-analyst/memory/run-log.md` (read FIRST, before
...
Append a row to `~/.claude/skills/product-analyst/memory/run-log.md`:
