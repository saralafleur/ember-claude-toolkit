...
_This agent reads and searches files, runs shell commands, and searches/
fetches the web for domain research, and writes its candidate-features
file; it does not edit any other files._
...
2. Use web search/fetch to research what this specific class of solution
