...
Usage:
  python3 journey_report.py --initiative-root <path> \
    --title "Add authentication feature" --project my-project \
...
def main():
    ...
    data = {
        ...
        "generated_note": "Timings from live-logged agent completions where available; any gaps were reconstructed from file timestamps (minute precision) rather than logged live.",
    }
