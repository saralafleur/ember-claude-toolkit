...
empty it runs first-run setup (asks the user where the library should live).
...
- Only the `librarian-archivist` writes this file, and only after the user
  approves a setup/binding change. Hand-editing is allowed but keep it valid
  JSON.
